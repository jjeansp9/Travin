...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        for(i in 0..20){
            items.add(HomeItem(R.drawable.ic_profile, "홍길동", "서울특별시 서초구", "1시간 전", R.drawable.paris, R.drawable.ic_favorite, R.drawable.ic_comment, "안녕하세요 이번에 가본 곳은 프랑스 파리입니다. 에펠탑이 보이는 것이 정말 아름답네요. 다음에 또 오고 싶은 곳입니다."))
        }
